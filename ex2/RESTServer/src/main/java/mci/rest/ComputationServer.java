        ...
        try {
            ...
            if(load_balancer_url != null && !load_balancer_url.isEmpty()) {
                ...
                if (Objects.equals(result, "\"OK\"")) {
                    System.out.println("Service registered on Loadbalancer: " + load_balancer_url);
                    System.out.println("Service URL: " + serverUrl);
                } else {
                    System.out.println("Service could not be registered on Loadbalancer: " + load_balancer_url);
                }
            } else {
                System.out.println("No Load Balancer URL found. Starting server without registration.");
            }
